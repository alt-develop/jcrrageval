...
Since Faithfulness is the most crucial aspect, the scores for relevance, completeness, and utilization cannot exceed the Faithfulness score. The final line of your evaluation should adhere to the following format:
1. faithfulness: a single score between 0 and 5.
2. relevance: a single score between 0 and faithfulness score.
3. completeness: a single score between 0 and faithfulness score.
4. utilization: a single score between 0 and faithfulness score.
